...
import { clearCache, useFetch } from "./useFetch";
...
describe("useFetch()", () => {
  ...
  it("Cache : returns cached data without fetching again", async () => {
    ...
    expect(mockFetch).toHaveBeenCalledOnce(); // fetch appelé une seule fois
  });
});
